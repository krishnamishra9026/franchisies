...
class CampaignController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $campaigns = $campaigns->paginate(115);

        $active_campaigns = Campaign::where('status', 1)->orderBy('id', 'desc')->paginate(115);

        $inactive_campaigns = Campaign::where('status', 0)->orderBy('id', 'desc')->paginate(115);

        return view('campaigns.index', compact('campaigns', 'sponsors', 'categories', 'filter_status', 'filter_title', 'filter_sponsor', 'filter_category', 'filter_date_from', 'filter_date_to', 'active_campaigns', 'inactive_campaigns'));
    }
    ...
    public function create()
    {
        ...
        return view('campaigns.create', compact('sponsors', 'categories', 'content_types'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('campaigns.edit', compact('campaign', 'sponsors', 'categories', 'content_types', 'selected_content_types'));
    }
