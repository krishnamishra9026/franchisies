...
class MarketplaceController extends Controller
{
    ...
    public function creators(Request $request)
    {
       ...
       $creators = Creator::whereIn('id', $merged);
        ...
        return view('frontend.marketplace.creators', compact('creators', 'categories', 'states', 'countries', 'cities'));
    }
    ...
    public function category(Request $request, $slug)
    {
       ...
       $creators = Creator::whereIn('id', $merged);
        ...
        $category_page_description = Category::where('slug', $slug)->orWhere('id', $slug)->value('page_description');        
        ...
        return view('frontend.marketplace.creators', compact('creators', 'categories', 'states', 'countries', 'cities', 'filter_category', 'category_meta_title', 'category_meta_description', 'category_h1_title', 'category_h2_tag', 'category_page_description'));
    }
