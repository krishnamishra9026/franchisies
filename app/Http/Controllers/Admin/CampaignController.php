...
class CampaignController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.campaigns.index', compact('campaigns', 'sponsors', 'categories', 'filter_status', 'filter_title', 'filter_sponsor', 'filter_category', 'filter_date_from', 'filter_date_to'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.campaigns.create', compact('sponsors', 'categories', 'content_types'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.campaigns.edit', compact('campaign', 'sponsors', 'categories', 'content_types', 'selected_content_types'));
    }
