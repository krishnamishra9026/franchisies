...
class EnquiryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.enquiries.index', compact('enquiries', 'filter_status', 'filter_name', 'filter_email', 'filter_date_from', 'filter_date_to'));    
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.enquiries.index')->with('success', 'Enquiry added successfully');
    }
