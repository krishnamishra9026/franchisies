...
class Hestia_Footer extends Hestia_Abstract_Main {
	...
	public function bottom_footer_content() {
		...
		/* translators: %1$s is Theme Name, %2$s is WordPress */
			// esc_html__( '%1$s | Developed by %2$s', 'Winwinpromo' ),
			esc_html__( '%1$s Winwinpromo. %2$s', 'Copyright 2024.' ),
			esc_html__( '© Copyright 2024.', 'Copyright 2024.' ),
			/* translators: %1$s is URL, %2$s is WordPress */
			sprintf(
				'<a href="%1$s" rel="nofollow">%2$s</a>',
				esc_url( __( '', 'Copyright 2024.' ) ),
				'All Rights Reserved.'
			)
		);
