...
<head>
	...
	<?php 
		global $post;
		if( is_home()  )
		echo "Influencer Marketing & Creator Blog | WinWinPromo";
		else
	...
	?> </title>
	   ...
	   <?php 
	     if( is_home() ){
			echo "<meta name='description' content='Discover the newest trends, blogs, and top strategies in the creator economy and influencer marketing. Learn useful advice on selecting and hiring the best influencers to help you execute your campaigns effectively | WinWinPromo' >";
		 }  
	   ?>
