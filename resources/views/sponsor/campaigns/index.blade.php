                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                @if(isset($campaign->image))
                                                <div class="user-profile-image">
                                                    <img src="{{ asset('storage/uploads/campaigns/'.$campaign->image) }}" height="45" class="img-fluid" />
                                                </div>
                                                @else
                                                <div class="user-profile-image">
                                                    <img src="{{ asset('assets/images/thumbnails/placeholder.png') }}" class="img-fluid" />
                                                </div>
                                                @endif
                                            </td>
                                            <td style="width: 25%">
