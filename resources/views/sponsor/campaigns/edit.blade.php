        ...
        <div class="row">
            <div class="col-sm-12 col-12">
                <div class="Campaignadd BoxShadow formstyle">
                    <form method="post" action="{{ route('campaigns.update', $campaign->id) }}" class="row g-2" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12 col-12">
                              ...
                              <input type="text" name="title" required value="{{ old('title', $campaign->title) }}"  class="form-control" placeholder="Enter your title">
                              @error('title')
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="select2 form-control select2-multiple" required data-toggle="select2" multiple="multiple" data-placeholder="Choose ..." name="content_type[]">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" class="form-control" required name="price" value="{{ old('price', $campaign->price) }}" placeholder="Enter your price">
                                @error('price')
                            ...
                            <div class="col-md-6 col-12">
                              ...
                              <select class="form-control" required name="status" id="example-select">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="form-group">
                                    <div class="upload">
                                        <div class="uploadimg">
                                            <input type="file" onchange="loadPreview(this);" name="image" />
                                            @if(isset($campaign->image))
                                            <img height="65" id="preview_img" src="{{ asset('storage/uploads/campaigns/'.$campaign->image) }}">
                                            @else
