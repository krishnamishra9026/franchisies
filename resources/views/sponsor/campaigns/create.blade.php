                    ...
                    <form method="post" action="{{ route('campaigns.store') }}" class="row g-2" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-12 col-12">
                              ...
                              <input type="text" name="title" value="{{ old('title') }}" required  class="form-control" placeholder="Enter your title">
                              @error('title')
                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <textarea class="form-control" rows="4" cols="4" name="description"  placeholder="Enter description">{{ old('description') }}</textarea>
                                @error('description')
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select required class="select2 form-control select2-multiple" data-toggle="select2" multiple="multiple" data-placeholder="Choose ..." name="content_type[]">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" required class="form-control" name="price" value="{{ old('price') }}" placeholder="Enter your price">
                                @error('price')
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="form-group">
                                    <div class="upload">
                                        ...
                                        <div class="upbtn">
                                            <img id="preview_img" src="{{ asset('assets/images/frontend/icons/camera.png') }}" />
                                        </div>
