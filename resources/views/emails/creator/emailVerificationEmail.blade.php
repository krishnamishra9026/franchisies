...
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap');
    ...
    <div style="width: 600px; height:400px; margin: 0 auto;padding: 20px 30px;border: 1px solid #ddd;">
        ...
        <a style="font-family: 'Inter', sans-serif; font-size: 14px; color: #fff; background-color: #814E81; border-color: #814E81;text-decoration: none;padding: 10px 30px; border-radius: 4px;" href="{{ route('creator-user.verify', $token) }}">Verify Email</a>
