@extends('layouts.app')
@section('title', 'Welcome to Collab Marketplace Creators')
                ...
                <div class="col-sm-12 col-12">
                    <div class="searchbar BoxShadow">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Search for Creator">
                                    ...
                                    <div class="row creatorlist">
                                        ...
                                        <div class="col-sm-6 col-12 paddingleft paddingright">
                                            <div class="Lcaption">
                                                ...
                                                <div class="creator-Category">
                                                    <ul class="list-inline">
                                                        <li class="list-inline-item"><a href="#"><span> YouTube video inregration</span></a></li>
                                                        <li class="list-inline-item"><a href="#"><span> TikTok Reel</span></a></li>
                                                        <li class="list-inline-item"><a href="#"><span> Instagram Story</span></a></li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="col-sm-3 col-12">
                                            <div class="LRight">
                                                ...
                                                <div class="price">
                                                    <p>Starting from <span>$100 USD</span></p>
                                                </div>

                                                <div class="viewbtn">
                                                    <a href="{{ route('profileshow', 10) }}" class="btn btn-primary btn-lg">View Details</a>
                                                </div>
                                    ...
                                    <div class="row creatorlist">
                                        ...
                                        <div class="col-sm-6 col-12 paddingleft paddingright">
                                            <div class="Lcaption">
                                                ...
                                                <div class="creator-Category">
                                                    <ul class="list-inline">
                                                        <li><a href="#"><span> YouTube video inregration</span></a></li>
                                                        <li><a href="#"><span> TikTok Reel</span></a></li>
