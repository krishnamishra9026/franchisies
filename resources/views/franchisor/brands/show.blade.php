                        ...
                        <div class="table-responsive">
                            <table class="table-panel table table-bordered table-striped table-centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"><a href="{{ route('franchisor.orders.show', $order->id) }}">#{{ $order->id }}</a></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('franchisor.generate-purchase-order', $order->id) }}" class="btn btn-success btn-sm">Generate PO</a>
                                            @endif
                                            <a class="ms-2 btn btn-primary btn-sm" href="{{ route('franchisor.orders.show', $order->id) }}"><i class="dripicons-preview"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            @foreach(($buyer->invoices as $invoice)
                                    <tr>
                                        <td class="text-center"><a href="{{ route('franchisor.invoices.show', $invoice->id) }}">#{{ $invoice->id }}</a></td>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-primary btn-sm" href="{{ route('franchisor.invoices.show', $invoice->id) }}"><i class="dripicons-preview"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                            @else
