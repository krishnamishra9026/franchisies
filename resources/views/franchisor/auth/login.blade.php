        ...
        <div class="auth-fluid-form-box pb-4 px-3">
            <div class="align-items-center d-flex h-100">
                <div class="card-body">
                    ...
                    <!-- title-->
                    <h4 class="mt-0">Franchisor Login</h4>
                    <p class="text-muted mb-4">Enter your email address and password to access account.</p>

                    <!-- form -->
                    <form method="POST" action="{{ route('franchisor.login') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                                ...
                                <a href="{{ route('franchisor.password.request') }}" class="text-muted float-end"><small>Forgot
