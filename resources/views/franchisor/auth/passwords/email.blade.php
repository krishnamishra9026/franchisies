...
<html lang="en">
    <head>
        ...
        <meta content="A fully featured franchisor theme which can be used to build CRM, CMS, etc." name="description" />
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('franchisor.password.email') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                        ...
                        {{-- <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="{{ route('franchisor.login') }}" class="text-muted ml-1"><b>Log In</b></a></p>
                            </div>
                        </div> --}}
                    </div> <!-- end col -->
                </div>
