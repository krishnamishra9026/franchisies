                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-2 col-12 text-left">
                                <a href="{{ route('franchisor.enquiries.create') }}" class="btn btn-sm btn-danger"><i class="mdi mdi-plus-circle mr-1"></i>Add New</a>
                            </div>

                            <div class="col-md-12 col-12" id="">
                                    <div class="filter mt-3">
                                        <h4>Filter</h4>
                                        <form action="{{ route('franchisor.enquiries.index') }}">
                                            <div class="form-row">
                                                ...
                                                <div class="col text-end">
                                                    ...
                                                    <a href="{{ route('franchisor.enquiries.index') }}" class="btn btn-light"
                                    ...
                                    <tbody>
                                        @foreach ($enquiries as $enquiry)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mb-2">
                                                        <a href="{{ route('franchisor.enquiries.edit', $enquiry->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-eye"></i></a>
                                                    ...
                                                    <form id='delete-form{{ $enquiry->id }}'
                                                        action='{{ route('franchisor.enquiries.destroy', $enquiry->id) }}'
                                                        method='POST'>
