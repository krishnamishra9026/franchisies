...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('franchisor.user-management.index') }}">Customer Reviews</a>
                            </li>
    ...
    <form method="POST" action="{{ route('franchisor.user-management.index') }}" id="user-managementForm"
