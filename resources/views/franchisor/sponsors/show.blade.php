            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('franchisor.sponsors.index') }}">Sponsor</a>
                        </li>
...
<form method="POST" action="{{ route('franchisor.sponsors.update', $sponsor->id) }}" id="contactEnqueryForm"
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="{{ route('franchisor.sponsors.edit', $sponsor->id) }}" class="btn btn-sm btn-primary mr-1">Edit</a>
                            <a href="{{ route('franchisor.sponsors.index') }}" class="btn btn-sm btn-dark">Back</a>
