            ...
            <div class="row">
                <div class="col-sm-12 col-12">
                    <div class="searchbar BoxShadow">
                        <form action="{{ route('creator.marketplace.creators') }}">
                        ...
                        <div class="creators-tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link active" href="{{ route('creator.marketplace.creators') }}">Content Creators</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="{{ route('creator.marketplace.campaigns') }}">Ad Campaigns</a>
                                </li>
                              </ul>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-12">
                    <form action="{{ route('creator.marketplace.creators') }}" id="" method="GET">
                    <div class="search-creators">
                        <button type="button" id="ShowFilter" class="btn btn-primary mb-2  d-md-none">Show Filter</button>
                        <button type="button" id="HideFilter" class="btn btn-primary mb-2 d-md-none">Hide Filter</button>
                        <div class="BoxShadow">
                            <div class="row">
                                        ...
                                        <div class="filter-content">
                                                    ...
                                                    <li>
                                                        <div class="form-group mt-2 Csearch">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control filter-records" id="searchCity" name="city" placeholder="Enter City" value="{{ request()->get('city') }}"><button class="city-check input-group-text"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        </div>
                                                    </li>
                                            ...
                                            <div class="filterlist over-category">
                                                ...
                                                <ul>
                                                    ...
                                                    @php $checked = ( !empty($_GET['category']) && in_array($category->id, $_GET['category'] )) ? 'checked' : '';
                                                    if(empty($checked)){
                                ...
                                <div class="col-sm-9 col-12" id="Creator-list">
                                    ...
                                    <div class="row creatorlist @if(auth()->guard('creator')->user() && auth()->guard('creator')->user()->badge_ids != null) paidUser @endif">
                                        ...
                                        <div class="col-sm-6 col-12">
                                            <div class="Lcaption">
                                                <h2><a href="{{ route('creator.profileview', $creator->slug) }}">{{ $creator->talent_title }}</a></h2>
                                                ...
                                                <div class="followers">
                                                    <ul class="list-inline">
                                                        ...
                                                        <li><a href="https://www.instagram.com/" target="_blank"><span><img src="{{ asset('assets/images/frontend/icons/instagram.svg') }}" alt="instagram" /> {{ $creator->instagram_subscribers_or_followers }}</span></a></li>
                                                        @endif
                                                        @if($creator->youtube_connected)
                                                        <li><a href="https://youtube.com/" target="_blank"><span><img src="{{ asset('assets/images/frontend/icons/youtube-icon.svg') }}" alt="instagram" /> {{ $creator->youtube_subscribers_or_followers }}</span></a></li>
                                                        @endif
                                                        @if($creator->tiktok_connected)
                                                        <li><a href="https://www.tiktok.com/login" target="_blank"><span><img src="{{ asset('assets/images/frontend/icons/tiktok-icon.svg') }}" alt="instagram" /> {{ $creator->tiktok_subscribers_or_followers }}</span></a></li>
                                                        @endif
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-3 col-12">
                                            ...
                                            <div class="viewbtn">
                                                ...
                                                <a href="{{ route('creator.my-services') }}" class="btn btn-primary btn-lg">Edit</a>
                                                @else
                                                <a href="{{ route('creator.profileview', $creator->slug) }}" class="btn btn-primary btn-lg">View Details</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $("#clear_filter").click(function() {
        window.location.href = "{{ route('creator.marketplace.creators') }}";
    });

    $(".wishlist").click(function() {

        var user_id = "{{ auth()->guard('creator')->user()->id }}";
        ...
        $.ajax({
            method: 'post',
            url: "{{ route('creator.add-to-favorite') }}",
    ...
    $('.plateform-check').on('click', function () {
        ...
        if (queryMap.has(paramName)) {
            ...
            window.location.href = "{{ route('creator.marketplace.creators') }}"+'?'+paramsStr;
