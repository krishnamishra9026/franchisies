            ...
            <div class="row">
                <div class="col-sm-12 col-12">
                    <div class="searchbar BoxShadow">
                        <form action="{{ route('creator.marketplace.campaigns') }}">
                        ...
                        <div class="creators-tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link" href="{{ route('creator.marketplace.creators') }}">Content Creators</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link active" href="{{ route('creator.marketplace.campaigns') }}">Ad Campaigns</a>
                                </li>
                              </ul>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-12">
                    <form action="{{ route('creator.marketplace.campaigns') }}" id="" method="GET">
                        ...
                        <div class="BoxShadow">
                            <div class="row">
                                ...
                                <div class="col-sm-9 col-12" id="Creator-list">
                                    ...
                                    <div class="row creatorlist Sponsorlist @if(auth()->guard('creator')->user() && auth()->guard('creator')->user()->badge_ids != null) paidUser @endif">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.wt-searchgbtn', function(event) {
     ...
     $("#clear_filter").click(function() {
        window.location.href = "{{ route('creator.marketplace.campaigns') }}";
    });
...
<script>
     ...
     $('#filter_price').on('click', function () {
        ...
        if (queryMap.has(paramName)) {
            ...
            window.location.href = "{{ route('creator.marketplace.campaigns') }}"+'?'+paramsStr;
