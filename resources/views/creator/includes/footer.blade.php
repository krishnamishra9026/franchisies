        ...
        <div class="col-sm-7">
            <div class="footerinfo footerinfoD">
                <ul class="list-inline">
                    @if(count($pages))
                    @foreach($pages as $page)
                    <li><a href="{{ route('creator.pages',$page->slug) }}">{{$page->name}}</a></li>
                    @endforeach
                    @endif
                    <li><a href="{{ route('creator.support') }}">Support</a></li>
                    <li><a href="{{ route('suggestions') }}"><span>Write your suggestion</span></a></li>
                </ul>
            </div>
        </div>
    </div>
