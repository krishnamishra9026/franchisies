                    ...
                    <div class="row">
                                                    ...
                                                    <div class="d-flex chatuserlist align-items-start @if($key == 0) bg-active @endif mt-1 p-2">
                                                        <div class="proimg">
                                                            <div class="user-profile-image">
                                                                ...
                                                                <img src="{{ asset('storage/uploads/sponsors/'.$user->avatar) }}" class="me-2 rounded-circle" alt="{{ $user->firstname }}" />
                                                                @else
                                                                <img src="/assets/images/frontend/user-profile-placeholder.png" class="me-2 rounded-circle"  alt="Brandon Smith" />
                                                                @endif
                        ...
                        <div class="col-sm-6 col-12 borderleftright mobile-hide">
                            <div class="conversation">
                                <div class="chatuser">
                                    @if(isset($sposnor))
                                    <h5>{{@$sponsor->first_name}} {{@$sponsor->last_name}}</h5>
                                            ...
                                            <form  class="needs-validation chatform" novalidate="" name="chat-form" id="chat-form" method="POST" action="{{ route('creator.message.store') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col mb-2 mb-sm-0">
                                                        <input type="text" id="messsage" name="message" class="form-control border-0" placeholder="Enter your message here" required="">
                            ...
                            <div class="collabD">
                                    ...
                                    <div class="FProfile">
                                        ...
                                        <div class="caption cc-chat">
                                            @if(isset($sposnor))
                                            <h4>{{ @$sponsor->first_name }} {{ @$sponsor->last_name }}</h4>
                                            <p><span>@</span>{{ @$sponsor->username }}</p>
                                            @endif
                                        </div>
