...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.promo-codes.store') }}" id="content_typesForm"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="date" class="form-control" name="valid_from_date" value="{{ old('valid_from_date') }}" placeholder="Enter Valid From Date">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="date" class="form-control" name="valid_to_date" value="{{ old('valid_to_date') }}" placeholder="Enter Valid To Date">
                                @error('valid_to_date')
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    <option @if(old('type') == 'fixed') selected @endif value="fixed">Fixed</option>
                                    <option @if(old('type') == 'percent') selected @endif value="percent">Percent</option>
                                </select>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" placeholder="Coupon Value" name="value" value="{{ old('value') }}" class="form-control" />                                    
                                @error('value')  <p class="text-danger">{{$message}}</p> @enderror
                            </div>

                            <div class="col-md-12 mb-2">
                                <label for="no_of_uses" class="form-label">No. of uses</label>
                                <input type="number" id="no_of_uses" class="form-control" placeholder="Enter No. of uses" name="no_of_uses" value="{{ old('no_of_uses') }}" >
                            </div>
