...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.user-management.index') }}">User</a>
                            </li>
    ...
    <form method="POST" action="{{ route('admin.user-management.update', $user->id) }}" id="userForm"
