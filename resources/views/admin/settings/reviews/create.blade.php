...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.reviews-setting.index') }}">Reviews</a>
                            </li>
    ...
    <form method="POST" action="{{ route('admin.reviews-setting.store') }}" id="content_typesForm"
