                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-2 col-12 text-left">
                                <a href="{{ route('admin.reviews-setting.create') }}" class="btn btn-sm btn-danger"><i class="mdi mdi-plus-circle mr-1"></i>Add New</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($reviews as $review)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mb-2">
                                                        <a href="{{ route('admin.reviews-setting.edit', $review->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-square-edit-outline"></i></a>
                                                    ...
                                                    <form id='delete-form{{ $review->id }}'
                                                        action='{{ route('admin.reviews-setting.destroy', $review->id) }}'
                                                        method='POST'>
