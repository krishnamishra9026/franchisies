...
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add Badge</h4>
                </div>
            </div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.badges.store') }}" id="badgesForm"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="submit" class="btn btn-sm btn-success" form="badgesForm">Save</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
