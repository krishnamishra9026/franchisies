                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 col-12 text-left">
                                <a href="{{ route('admin.sponsors.create') }}" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-1"></i>Add New</a>
                            </div>
                                <div class="col-md-12 col-12" id="">
                                    <div class="filter mt-3">
                                        <h4>Filter</h4>
                                        <form action="{{ route('admin.sponsors.index') }}">
                                            <div class="form-row">
                                                ...
                                                <div class="col text-end">
                                                    ...
                                                    <a href="{{ route('admin.sponsors.index') }}" class="btn btn-light"
                                    ...
                                    <tbody>
                                        @foreach ($sponsors as $sponsor)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mb-2">
                                                        <a href="{{ route('admin.sponsors.edit', $sponsor->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-square-edit-outline"></i></a>
                                                        <a href="{{ route('admin.sponsors.show', $sponsor->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-eye"></i></a>
