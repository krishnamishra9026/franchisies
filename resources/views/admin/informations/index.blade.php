                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 text-left">
                                <a href="{{ route('admin.information-page-management.create') }}" class="btn btn-sm btn-danger float-end"><i class="mdi mdi-plus-circle mr-1"></i>Add
                                    New</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($informations as $information)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mb-2">
                                                        <a href="{{ route('admin.information-page-management.edit', $information->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-square-edit-outline"></i></a>
                                                    ...
                                                    <form id='delete-form{{ $information->id }}'
                                                        action='{{ route('admin.information-page-management.destroy', $information->id) }}'
                                                        method='POST'>
