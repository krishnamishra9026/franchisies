                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12 col-12 text-left">
                                <a href="{{ route('admin.creators.create') }}" class="btn btn-sm btn-primary"><i class="mdi mdi-plus-circle mr-1"></i>Add New</a>
                            </div>
                            <div class="col-md-12 col-12" id="">
                                <div class="filter mt-3">
                                    <h4>Filter</h4>
                                    <form action="{{ route('admin.creators.index') }}">
                                        <div class="form-row">
                                            ...
                                            <div class="col text-end">
                                                ...
                                                <a href="{{ route('admin.creators.index') }}" class="btn btn-light"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mb-2">
                                                        ...
                                                        <a href="{{ route('admin.creators.show', $creator->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-eye"></i></a>
                                                    ...
                                                    <form id='delete-form{{ $creator->id }}'
