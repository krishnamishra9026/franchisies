                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-2 col-12 text-left">
                                <a href="{{ route('admin.campaigns.create') }}" class="btn btn-sm btn-danger"><i class="mdi mdi-plus-circle mr-1"></i>Add New</a>
                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    name="filter_title" value="{{ @$filter_title }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <label for="filter_date_to"></label>
                                                <div class="input-group">
                                                    <select class="form-control" name="filter_sponsor" id="example-select">
                                                        <option value="">Select Sponsor</option>
                                                        @foreach($sponsors as $sponsor)
                                                        <option @if(@$filter_sponsor == $sponsor->id ) selected @endif value="{{$sponsor->id}}">{{$sponsor->first_name}} {{$sponsor->last_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <label for="filter_date_to"></label>
                                                <div class="input-group">
                                                    <select class="form-control" name="filter_category" id="example-select">
                                            ...
                                            <div class="col text-end">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <a href="{{ route('admin.campaigns.index') }}" class="btn btn-light" type="submit"><i class="mdi mdi-undo"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <tbody>
                                        @foreach ($campaigns as $campaign)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="mb-2">
                                                        <a href="{{ route('admin.campaigns.edit', $campaign->id) }}" class="btn btn-sm btn-primary mr-1"><i class="mdi mdi-square-edit-outline"></i></a>
                                                        <button type="button" class="btn btn-sm btn-danger cus-danger" onclick="confirmDelete({{ $campaign->id }})"><i class="mdi mdi-trash-can"></i></button>
                                                    </div>
